...
describe("bounds system", function() {
    it("should set the size of view components", function() {
        ...
        assert.strictEqual(testEntityAbsoluteBounds.x, 250);
        assert.strictEqual(testEntityAbsoluteBounds.y, 1500);
        assert.strictEqual(testEntityAbsoluteBounds.width, 500);
        assert.strictEqual(testEntityAbsoluteBounds.height, 1000);
    });
    it("should move components", function() {
        ...
        assert.strictEqual(testEntityRelativeBounds.x, 1);
        assert.strictEqual(testEntityRelativeBounds.y, 2);
    });
    it("should update max grid height", function() {
        ...
        eventManager.vent.trigger("SYSTEM:BOUNDS:UPDATE");
        assert.strictEqual(testHeightBeyondBounds, 78000);
    });
});