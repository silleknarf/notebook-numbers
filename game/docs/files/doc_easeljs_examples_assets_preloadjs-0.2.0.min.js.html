...
<head>
    <meta charset="utf-8">
    <title>doc/easeljs/examples/assets/preloadjs-0.2.0.min.js - Notebook Numbers</title>
    ...
    <div id="api-tabview" class="tabview">
        ...
        <label for="api-show-deprecated">
            ...
            <div class="apidocs">
                <div id="docs-main">
                    <div class="content">
                        <h1 class="file-heading">File: doc/easeljs/examples/assets/preloadjs-0.2.0.min.js</h1>
